...
export default function ReservationForm() {
  ...
  return (
    <div className="rounded-[28px] border border-white/10 bg-[#240607] p-5 text-white shadow-[0_30px_80px_rgba(0,0,0,0.5)] sm:p-8">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-[0.72rem] font-bold uppercase tracking-[0.24em] text-antonias-gold/80">
            Paso {step} de 5
          </p>
          <h2 className="mt-3 text-[1.9rem] font-extrabold uppercase leading-[0.95] text-antonias-gold sm:text-[2.3rem]">
            {getStepTitle(step)}
          </h2>
        </div>
        <Link
          href="/"
          className="inline-flex min-h-11 items-center justify-center rounded-full border border-white/10 px-4 text-[0.92rem] font-semibold text-white transition hover:border-antonias-gold/60"
        >
          Inicio
        </Link>
      </div>
