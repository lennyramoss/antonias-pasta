export default function LocationHours() {
  return (
    <section
      ...
      className="bg-antonias-burgundy py-20 text-antonias-gold sm:py-28"
    >
      <div className="mx-auto grid w-[calc(100%-2rem)] max-w-[980px] items-center gap-10 md:grid-cols-[0.85fr_1.15fr] md:gap-16">
        <div>
          <p className="text-[0.78rem] font-bold uppercase tracking-[0.36em] text-antonias-gold/75">
            Ubicación
          </p>
          <h2
            id="ubicacion-title"
          ...
          <address className="mt-8 not-italic">
            ...
            <p className="mt-5 text-[1rem] font-medium leading-relaxed text-white/80 sm:text-[1.08rem]">
              Todos los días 19:00 - 00:00
            </p>
          </address>
        </div>

        <div className="overflow-hidden rounded-[22px] bg-white shadow-[0_28px_80px_rgba(20,16,15,0.18)]">
          <iframe
            title="Ubicación de Antonias Pasta en Trilenium Tigre"
            src="https://www.google.com/maps?q=Trilenium%20Tigre&output=embed"
            loading="lazy"
