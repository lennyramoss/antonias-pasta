...
export default function Hero() {
  return (
    <header className="relative flex h-[82svh] items-center justify-center overflow-hidden bg-antonias-base px-6 text-center text-white">
      <Image
      ...
      <div className="relative z-10 mx-auto w-full max-w-[72rem]">
        <h1 className="text-balance text-white [text-shadow:0_12px_34px_rgba(0,0,0,0.5)]">
          <span
            className="block text-[4.6rem] leading-[0.88] tracking-normal [font-family:var(--font-catalish-huntera)] sm:text-[7.4rem] lg:text-[10rem]"
          >
            Antonias
          </span>
          <span
